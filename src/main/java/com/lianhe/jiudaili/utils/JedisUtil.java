...
public class JedisUtil {
    ...
    /*public static void main(String[] args) {
        JedisUtil jedisUtil = new JedisUtil(SystemCon.REDISHOST, SystemCon.REDISPORT, SystemCon.REDISPASS);
        jedisUtil.setStr("1","123");
        System.out.println(jedisUtil.getStr("1"));
    }*/
}
